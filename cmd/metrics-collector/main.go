...
func main() {
	...
	cmd.Flags().StringArrayVar(&opt.RecordingRules, "recordingrule", opt.RecordingRules, "Define recording rules to reduce metrics before sending them, one rule per line.")
